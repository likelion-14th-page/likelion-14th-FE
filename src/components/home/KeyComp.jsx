  ...
  return (
    <div className="flex flex-col gap-[24px] bg-black ">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-[16px]">
        <div className="text-center sm:text-[20px] sm:font-semibold text-[16px] font-semibold text-black flex bg-bright-orange-02 px-[40px] py-[32px] gap-[12px] rounded-[16px] justify-center items-center whitespace-nowrap">
