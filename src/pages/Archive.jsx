...
const Archive = () => {
    ...
    const projects = [
        // 해커톤
        {
            ...
            category: '해커톤',
            title: 'SpaceFarm',
            subtitle: '도심 속에 가꾸는 나만의 작은 자연! 도시농부와 유휴 공간을 연결하는 텃밭 매칭 서비스, SpaceFarm🌱',
            designer: '정윤성',
            frontend: '김준희 이승주',
            backend: '윤서현 황신애'
        },
        {
            ...
            category: '해커톤',
            title: 'Crossbiz',
            subtitle: '복잡한 비자 발급 절차는 그만! Crossbiz로 맞춤형 비자 추천 및 관리를 받아보세요🪄',
            designer: '이승연',
            frontend: '김지윤 안준석',
            backend: '이광휘 장민지'
        },
        {
            ...
            category: '해커톤',
            title: '아끼미',
            subtitle: '재미있는 절약! 효과적인 절약! 나만의 챗봇과 함께하는 목표중심형 절약챌린지 서비스, 아끼미!🌟',
            designer: '고다현',
            frontend: '김채원 이승찬',
            backend: '고여경 한정후'
        },
        {
            ...
            category: '해커톤',
            title: 'GLOW',
            subtitle: '예술가들을 조명하다. 비주류 예술가들을 위한 전시 플랫폼, GLOW 💫',
            designer: '윤희서',
            frontend: '이주영 황영준',
            backend: '박서영 박태원'
        },
        {
            ...
            category: '해커톤',
            title: 'MAPOOP',
            subtitle: '내 주변 마포구 화장실 위치부터 청결 리뷰까지, 헤매지 말고 한눈에 확인하는 MAPOOP',
            designer: '강채원',
            frontend: '박채아 손주완',
            backend: '김태우 윤지민'
        },
        // 데모데이
        {
            ...
            category: '데모데이',
            title: '손빛',
            subtitle: '농인들의 손빛이 꺼지지 않도록. 농인들의 병원 진료를 돕는 실시간 소통 지원 서비스, 손빛✨',
            designer: '정윤성',
        ...
        },
        {
            ...
            category: '데모데이',
            title: '땅땅땅',
            subtitle: 'AI 판사의 판결을 중심으로, 사용자가 변호사나 배심원이 되어 논리로 대결하는 재판 구조 기반의 밸런스 게임 플랫폼',
            designer: '강채원',
        ...
        },
        {
            ...
            category: '데모데이',
            title: '또박이',
            subtitle: '발음 연습에 이어 상황별 대화 연습까지! 조음장애 환자를 위한 AI 아바타 학습 서비스, 또박이',
            designer: '고다현',
            frontend: '손주완 김지윤',
            backend: '김다연 고여경'
        },
        {
            ...
            category: '데모데이',
            title: 'PLIP',
            subtitle: '심심할 땐, 그냥 Plip! 가볍게 사고 팔고 입찰하는 새로운 재미 : 경매형 중고거래',
            designer: '윤희서',
            frontend: '안준석 김채원',
            backend: '김태우 박태원 한정후'
        },
        ...
        },
        {
            ...
            category: '아이디어톤',
            title: 'Re:Habit',
            subtitle: '병원 밖에서도 정확한 재활 운동을 도와주는 디지털 재활 파트너, Re:Habit',
            designer: '윤희서',
            frontend: '안준석 이승주',
            backend: '김태우 장민지'
        },
        ...
        },
        {
            ...
            category: '아이디어톤',
            title: 'AiBE',
            subtitle: '사용자의 몰입도를 AI가 실시간으로 감지해 음악 볼륨을 자동조절해 주는 집중력 케어 서비스, AiBE',
            designer: '이민정',
            frontend: '이윤서 황영준',
            backend: '윤지민 한정후'
        }
